    ...
    company: [
      {
        ...
        news: [
          { id: 1, title: "4대 금융그룹, 지난해 평균 이직률 '뚝'·근속연수 '쑥'" },
          { id: 2, title: "건설업계 vs 시멘트업계, 가격 조정 놓고 신경전" },
          { id: 3, title: "공장 가동률 100% 넘겼지만, 판매량 '뚝'···현대차 인니서 무슨 일" },
          { id: 4, title: "파리올림픽, 개막 전부터 '시끌'···삼성 갤럭시 마케팅 이상없나?" },
          { id: 5, title: "유튜브도 뛰어들었다···'콘텐츠 커머스' 경쟁 본격화" },
          { id: 6, title: "상반기 전국 청약경쟁률 6.22대 1···서울은 105.8대 1" },
        ],
      },
    ],
  },
    ...
    company: [
      {
        ...
        news: [
          { id: 1, title: "폭우·태풍에 좌우될 한 해 농사...피해 줄이려면?" },
          { id: 2, title: '운전자 "급발진"...목격자 "브레이크 밟고 멈춰"' },
          { id: 3, title: '라인야후, 네이버 자본관계 재검토에 "단기적 자본이동 곤란"' },
          { id: 4, title: "EU, 빅테크에 천문학적 과징금 예고...삼성전자 불똥?" },
          { id: 5, title: "지난해 국민 10명 중 4명꼴 '의료용 마약류' 처방받아" },
          {
            id: 6,
    ...
    company: [
      {
        ...
        news: [
          ...
          { id: 2, title: "Record labels are suing tech companies for copying classic songs" },
          {
            id: 3,
    ...
    company: [
      {
        ...
        news: [
          { id: 1, title: "[왓IS] 이유영, 결혼‧임신 깜짝 발표…비연예인과 2년 열애 끝 결실" },
          { id: 2, title: "[2024 K포럼] IT 기기, 화장품 언박싱 콘텐츠 제작 현장 공개" },
          { id: 3, title: "10대 트롯 가수 오유진 ‘예쁘잖아’로 ‘더쇼’ 출연" },
          { id: 4, title: "방탄소년단 진, 파리올림픽 성화봉송…“화합·평화 메시지 전파” [공식]" },
          { id: 5, title: "‘이제 혼자다’ 조윤희 “이혼 없다는 마음으로 결혼했지만…매일 악몽”" },
          {
            id: 6,
    ...
    company: [
      {
        ...
        news: [
          { id: 1, title: "국민의힘 대전시당, 시의원 상습 성추행 의혹 공식사과" },
          { id: 2, title: "늘어나는 고령운전자 교통사고… 충북 1년새 13% 증가" },
          { id: 3, title: "충청권 행정구역 통합 찬성… 세종 포함은 반대" },
          { id: 4, title: "충청지역 소비자물가 보합세… 과일값은 비싸" },
          { id: 5, title: "충북 곳곳에 많은 비…40대 남성 캠핑중 고립·구조" },
          {
            id: 6,
